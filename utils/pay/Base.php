...
class Base
{
    const KEY = '写自己的'; //支付秘钥需要更改成自己的
    const APPID = '写自己的'; //APPID需要更改为自己的
    const MCHID = '写自己的'; //商户号需要更改成自己的
    const SECRET = '写自己的'; //开发者密码需要更改为自己的
    const UOURL = 'https://api.mch.weixin.qq.com/pay/unifiedorder'; //无需更改 统一下单API地址
    const NOTIFY = 'https://www.liminghulian.com/pay/notify.php';   //支付通知地址需要更改成你自己服务器的地址
